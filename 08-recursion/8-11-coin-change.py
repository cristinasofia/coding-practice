class Solution(object):
    ...
    def minNumberCoins(self, coins, amount):
    ...
    def coinCombinations(self, coins, amount):
...
def main():
    ...
    print(obj.minNumberCoins(coins, amount))
    ...
    print(obj.coinCombinations(coins, amount))
